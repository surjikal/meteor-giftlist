...
function addTodoFromView(evt, tmpl) {
  console.debug("HO!");

  var fields = {
    text: tmpl.find('#new-todo-name')
  , url: tmpl.find('#new-todo-url')
  , price: tmpl.find('#new-todo-price')
  };

  if (!fields.text.value) return false;
...
Template.todos.events({"submit form": addTodoFromView, });
